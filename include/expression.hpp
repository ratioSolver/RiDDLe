...
namespace riddle
{
  ...
  {
  public:
    and_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}

    [[nodiscard]] expr evaluate(const scope &scp, env &ctx) const override;

    friend utils::s_ptr<expression> push_negations(utils::s_ptr<expression> expr) noexcept;
    friend utils::s_ptr<expression> distribute(utils::s_ptr<expression> expr) noexcept;
  ...
  {
  public:
    or_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}
  ...
  {
  public:
    xor_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}
  ...
  {
  public:
    not_expression(utils::s_ptr<expression> xpr) noexcept : xpr(std::move(xpr)) {}
  ...
  private:
    utils::s_ptr<expression> xpr;
  };

  class minus_expression final : public expression
  {
  public:
    minus_expression(utils::s_ptr<expression> xpr) noexcept : xpr(std::move(xpr)) {}
  ...
  {
  public:
    sum_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}
  ...
  {
  public:
    subtraction_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}
  ...
  {
  public:
    product_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}
  ...
  {
  public:
    division_expression(std::vector<utils::s_ptr<expression>> &&xprs) noexcept : xprs(std::move(xprs)) {}
  ...
  {
  public:
    lt_expression(utils::s_ptr<expression> lhs, utils::s_ptr<expression> rhs) noexcept : lhs(std::move(lhs)), rhs(std::move(rhs)) {}

    [[nodiscard]] expr evaluate(const scope &scp, env &ctx) const override;

  private:
    utils::s_ptr<expression> lhs;
    utils::s_ptr<expression> rhs;
  };

  class le_expression final : public expression
  {
  public:
    le_expression(utils::s_ptr<expression> lhs, utils::s_ptr<expression> rhs) noexcept : lhs(std::move(lhs)), rhs(std::move(rhs)) {}
  ...
  {
  public:
    gt_expression(utils::s_ptr<expression> lhs, utils::s_ptr<expression> rhs) noexcept : lhs(std::move(lhs)), rhs(std::move(rhs)) {}
  ...
  {
  public:
    ge_expression(utils::s_ptr<expression> lhs, utils::s_ptr<expression> rhs) noexcept : lhs(std::move(lhs)), rhs(std::move(rhs)) {}
  ...
  {
  public:
    eq_expression(utils::s_ptr<expression> lhs, utils::s_ptr<expression> rhs) noexcept : lhs(std::move(lhs)), rhs(std::move(rhs)) {}
  ...
  {
  public:
    constructor_expression(std::vector<id_token> &&tp_id, std::vector<utils::s_ptr<expression>> &&args) noexcept : type_id(std::move(tp_id)), arguments(std::move(args)) {}
  ...
  {
  public:
    call_expression(std::vector<id_token> &&obj_id, id_token &&fn_id, std::vector<utils::s_ptr<expression>> &&args) noexcept : object_id(std::move(obj_id)), function_id(std::move(fn_id)), arguments(std::move(args)) {}
