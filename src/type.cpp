...
namespace riddle
{
    ...
    [[nodiscard]] std::unordered_map<std::shared_ptr<component>, std::vector<atom_expr>> component_type::partition_atoms() const noexcept
    {
        std::unordered_map<std::shared_ptr<component>, std::vector<atom_expr>> partition;
