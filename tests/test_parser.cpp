...
public:
    ...
    riddle::enum_expr new_enum(riddle::component_type &tp, std::vector<std::reference_wrapper<const utils::enum_val>> &&values) override { return std::make_shared<riddle::enum_item>(tp, std::move(values), 0); }
